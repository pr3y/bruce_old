...
void credits_setup(){
  ...
  DISP.qrcode("https://github.com/pr3y/m5-bruce", 145, 22, 100, 5);
...
void portal_setup(){
 ...
 // #endif
  ...
  cursor = 0;
  rstOverride = true;
  printHomeToScreen(EvilSsid, selectedTemplate);
    ...
    switch (current_proc) {
      ...
      case 19:
        ...
        case 30:
          ...
          DISP.setTextColor(FGCOLOR, BGCOLOR);
          local_scan_setup(WiFi.localIP().toString().c_str());
          // SCAN LOCAL HOSTS
          break;
        case 31:
          template_select_setup();
